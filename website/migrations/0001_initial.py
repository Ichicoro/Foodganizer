# Generated by Django 3.2.6 on 2021-09-07 14:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_access_uuid', models.UUIDField(default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PJR', 'Pending Join Request'), ('PI', 'Pending Invitation'), ('AM', 'Active Membership')], default='AM', max_length=3)),
                ('invited_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invites_set', to=settings.AUTH_USER_MODEL)),
                ('kitchen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.kitchen')),
